namespace KBEngine
{
	...
	*/
    public class KBEngineApp
    {
        ...
        // 可以直接从本地加载来提供登录速度
        private PersistentInfos _persistentInofs = null;
        ...
        public virtual bool initialize(KBEngineArgs args)
        {
            ...
            if (args.persistentDataPath != "")
                _persistentInofs = new PersistentInfos(args.persistentDataPath);
            ...
            while (stream.length() > 0)
            {
                ...
                while (propertysize > 0)
                {
                    ...
                    if (Class != null)
                    {
                        try
                        {
                            setmethod = Class.GetMethod("set_" + name, System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public);
                        }
                        catch (Exception e)
                        {
